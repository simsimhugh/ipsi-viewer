...
export const metadata: Metadata = {
  title: "학군 뷰어 — 수도권 중학교 진학 결과",
  description: "수도권(서울/경기/인천) 중학교 졸업생 진로(특목·자사·과학·외고) 한눈 비교",
};
        ...
        <header className="border-b border-slate-200 bg-white">
          <div className="mx-auto max-w-7xl px-6 py-4 flex items-center justify-between">
            <a href="/" className="text-lg font-bold text-slate-900">
              학군 뷰어 <span className="text-sm font-normal text-slate-500">— 수도권 중학교 진학 결과</span>
            </a>
